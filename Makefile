...
docker-build:
	...
	@docker run --rm -v ${PWD}:/var/www/html/app php-docker-bootstrap make dependencies

docker-tests:
	@docker run --rm -v ${PWD}:/var/www/html/app php-docker-bootstrap make tests

docker-coverage:
	@docker run --rm -v ${PWD}:/var/www/html/app php-docker-bootstrap make coverage
